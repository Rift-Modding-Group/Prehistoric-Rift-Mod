...
import com.anightdazingzoroark.rift.Blocks;
...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        //thatch blocks
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "oak_thatch_block"), OAK_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "birch_thatch_block"), BIRCH_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "spruce_thatch_block"), SPRUCE_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "jungle_thatch_block"), JUNGLE_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "dark_oak_thatch_block"), DARK_OAK_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "acacia_thatch_block"), ACACIA_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "crimson_thatch_block"), CRIMSON_THATCH_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Blocks.MOD_ID, "warped_thatch_block"), WARPED_THATCH_BLOCK);
