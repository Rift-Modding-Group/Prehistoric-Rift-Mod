...
public class RiftUpdateIndividualBoxDeployedCreatureClient extends RiftLibMessage<RiftUpdateIndividualBoxDeployedCreatureClient> {
    ...
    @Override
    public void executeOnServer(MinecraftServer minecraftServer, RiftUpdateIndividualBoxDeployedCreatureClient message, EntityPlayer messagePlayer, MessageContext messageContext) {
    ...
    @Override
    public void executeOnClient(Minecraft minecraft, RiftUpdateIndividualBoxDeployedCreatureClient message, EntityPlayer messagePlayer, MessageContext messageContext) {
        EntityPlayer player = (EntityPlayer) messagePlayer.world.getEntityByID(message.playerId);
        RiftCreature creature = (RiftCreature) messagePlayer.world.getEntityByID(message.creatureId);
        if (player != null && creature != null) {
            //find creature box
