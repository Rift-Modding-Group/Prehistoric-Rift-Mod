...
public class RiftManualUseMove extends RiftLibMessage<RiftManualUseMove> {
    ...
    @Override
    public void executeOnServer(MinecraftServer minecraftServer, RiftManualUseMove message, EntityPlayer messagePlayer, MessageContext messageContext) {
    ...
    @Override
    public void executeOnClient(Minecraft minecraft, RiftManualUseMove message, EntityPlayer messagePlayer, MessageContext messageContext) {}
}
