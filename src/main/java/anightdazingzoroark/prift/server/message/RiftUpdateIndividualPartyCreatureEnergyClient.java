...
public class RiftUpdateIndividualPartyCreatureEnergyClient extends RiftLibMessage<RiftUpdateIndividualPartyCreatureEnergyClient> {
    ...
    @Override
    public void executeOnServer(MinecraftServer minecraftServer, RiftUpdateIndividualPartyCreatureEnergyClient message, EntityPlayer messagePlayer, MessageContext messageContext) {
    ...
    @Override
    public void executeOnClient(Minecraft minecraft, RiftUpdateIndividualPartyCreatureEnergyClient message, EntityPlayer messagePlayer, MessageContext messageContext) {
        EntityPlayer player = (EntityPlayer) messagePlayer.world.getEntityByID(message.playerId);
        if (player == null) return;
        IPlayerTamedCreatures playerTamedCreatures = player.getCapability(PlayerTamedCreaturesProvider.PLAYER_TAMED_CREATURES_CAPABILITY, null);
