...
public class RiftForceSyncPartyNBT extends AbstractMessage<RiftForceSyncPartyNBT> {
    ...
    @Override
    public void onClientReceived(Minecraft minecraft, RiftForceSyncPartyNBT message, EntityPlayer messagePlayer, MessageContext messageContext) {
    ...
    @Override
    public void onServerReceived(MinecraftServer minecraftServer, RiftForceSyncPartyNBT message, EntityPlayer messagePlayer, MessageContext messageContext) {
        EntityPlayer player = (EntityPlayer) messagePlayer.world.getEntityByID(message.playerId);
        IPlayerTamedCreatures playerTamedCreatures = player.getCapability(PlayerTamedCreaturesProvider.PLAYER_TAMED_CREATURES_CAPABILITY, null);
