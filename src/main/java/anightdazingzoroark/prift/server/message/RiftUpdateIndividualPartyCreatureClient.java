...
public class RiftUpdateIndividualPartyCreatureClient implements IMessage {
    ...
    public static class Handler implements IMessageHandler<RiftUpdateIndividualPartyCreatureClient, IMessage> {
        @Override
        public IMessage onMessage(RiftUpdateIndividualPartyCreatureClient message, MessageContext ctx) {
            FMLCommonHandler.instance().getWorldThread(ctx.netHandler).addScheduledTask(() -> handle(message, ctx));
            return null;
        }

        private void handle(RiftUpdateIndividualPartyCreatureClient message, MessageContext ctx) {
