...
public class RiftUpdateIndividualPartyCreatureXPClient implements IMessage {
    ...
    public static class Handler implements IMessageHandler<RiftUpdateIndividualPartyCreatureXPClient, IMessage> {
        @Override
        public IMessage onMessage(RiftUpdateIndividualPartyCreatureXPClient message, MessageContext ctx) {
            FMLCommonHandler.instance().getWorldThread(ctx.netHandler).addScheduledTask(() -> handle(message, ctx));
            return null;
        }

        private void handle(RiftUpdateIndividualPartyCreatureXPClient message, MessageContext ctx) {
