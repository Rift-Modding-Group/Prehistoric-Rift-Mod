...
public class DilophosaurusSpit extends EntityArrow implements IRiftProjectile, IProjectile {
    ...
    public ItemStack getItemToRender() {
        return new ItemStack(RiftProjectileAnimatorRegistry.DILOPHOSAURUS_SPIT);
    }
                ...
                if (entity instanceof RiftCreaturePart) {
                    ...
                    if (parent != this.shootingEntity) {
                        ...
                        if (entity.attackEntityFrom(damagesource, (float) i)) {
                            parent.addPotionEffect(new PotionEffect(MobEffects.POISON, 10 * 20));
