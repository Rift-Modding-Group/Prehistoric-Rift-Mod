...
public class RiftProtectOwner extends EntityAIOwnerHurtByTarget {
    ...
    public boolean shouldExecute() {
        return !this.creature.isBeingRidden() && (this.creature.getTameBehavior() == TameBehaviorType.ASSIST || this.creature.getTameBehavior() == TameBehaviorType.NEUTRAL) && !this.creature.isUsingWorkstation() && super.shouldExecute();
    }
}
