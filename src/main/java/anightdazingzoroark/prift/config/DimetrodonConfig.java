...
public class DimetrodonConfig extends RiftConfig {
    ...
    public static int dimetrodonDensityLimit = 4;
    ...
    public DimetrodonConfig(Configuration config) {
        super(config, new String[]{"tag:sandy:10:1:1:CREATURE", "tag:savanna:10:1:1:CREATURE"});
    ...
    public void init() {
        ...
        dimetrodonDensityLimit = config.getInt("Density Limit", "Spawning", 4, 1, 69420666, "Maximum amount of creatures of this type in a 64 x 64 x 64 area");
