...
public class TyrannosaurusConfig extends RiftConfig {
    ...
    public static String[] tyrannosaurusTargets = {"minecraft:player", "minecraft:pig", "minecraft:chicken", "minecraft:cow", "minecraft:sheep", "minecraft:ocelot", "minecraft:wolf", "minecraft:rabbit", "minecraft:horse", "minecraft:donkey", "minecraft:mule", "minecraft:llama", "prift:stegosaurus", "prift:dodo", "prift:triceratops"};
    ...
    public void init() {
        ...
        tyrannosaurusTargets = config.getStringList("Tyrannosaurus Targets", "General", new String[]{"minecraft:player", "minecraft:pig", "minecraft:chicken", "minecraft:cow", "minecraft:sheep", "minecraft:ocelot", "minecraft:wolf", "minecraft:rabbit", "minecraft:horse", "minecraft:donkey", "minecraft:mule", "minecraft:llama", "prift:stegosaurus", "prift:dodo", "prift:triceratops"}, "Identifiers of mobs that the Tyrannosaurus will actively hunt");
