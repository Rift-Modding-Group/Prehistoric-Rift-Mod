...
public class MegalocerosConfig extends RiftConfig {
    ...
    public static String[] megalocerosMineBlock = {"minecraft:leaves:-1", "minecraft:leaves2:-1"};
    ...
    public void init() {
        ...
        megalocerosMineBlock = config.getStringList("Megaloceros Harvestable Blocks", "General", new String[]{"minecraft:leaves:-1", "minecraft:leaves2:-1"}, "List of blocks that Megaloceroses when set to harvest on wander will mine. To add items add \"<insert item's identifier here>:<insert data id here>\"");
