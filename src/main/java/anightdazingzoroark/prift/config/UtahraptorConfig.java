...
public class UtahraptorConfig extends RiftConfig {
    ...
    public void init() {
        ...
        utahraptorTargets = config.getStringList("Utahraptor Targets", "General", new String[]{"minecraft:player", "minecraft:pig", "minecraft:chicken", "minecraft:cow", "minecraft:sheep", "minecraft:ocelot", "minecraft:wolf", "minecraft:rabbit", "minecraft:horse", "minecraft:donkey", "minecraft:mule", "minecraft:llama", "minecraft:villager", "prift:stegosaurus", "prift:dodo", "prift:triceratops"}, "Identifiers of mobs that the Utahraptor will actively hunt");
    }
