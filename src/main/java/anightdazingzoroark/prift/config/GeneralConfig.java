...
public class GeneralConfig {
    ...
    public static String[] mountOverrideItems = {"item:minecraft:bow:-1", "item:minecraft:shield:-1"};
    public static boolean mountConsumablesCanOverride = true;
    ...
    public static String[] universalCarnivoreTargets = {"minecraft:player", "minecraft:pig", "minecraft:chicken", "minecraft:cow", "minecraft:sheep", "minecraft:ocelot", "minecraft:wolf", "minecraft:rabbit", "minecraft:horse", "minecraft:donkey", "minecraft:mule", "minecraft:llama", "minecraft:villager", "prift:stegosaurus", "prift:dodo", "prift:triceratops", "prift:parasaurolophus", "prift:megaloceros", "prift:gallimimus"};
    ...
    public static void init(Configuration config) {
        ...
        mountOverrideItems = config.getStringList("List of items that override creature controls when held in main hand", "General", new String[]{"item:minecraft:bow:-1", "item:minecraft:shield:-1"}, "When riding a creature you can't use almost anything to make room for the controls of the creature being ridden. Items or Ore Dictionary tags in this list can still be used however. To add Ore Dictionary tags add \"oreDic:<insert tag name here>\", while to add items add \"item:<insert item's identifier here>:<insert data id here>\". Food items can still be eaten while riding hence their exclusion");
        mountConsumablesCanOverride = config.getBoolean("Consumables can override creature controls", "General", true, "Whether or not consumables (items that extend the ItemPotion or ItemFood classes) override creature controls when held in main hand");
        ...
        universalCarnivoreTargets = config.getStringList("List of mobs carnivores will attack", "General", new String[]{"minecraft:player", "minecraft:pig", "minecraft:chicken", "minecraft:cow", "minecraft:sheep", "minecraft:ocelot", "minecraft:wolf", "minecraft:rabbit", "minecraft:horse", "minecraft:donkey", "minecraft:mule", "minecraft:llama", "minecraft:villager", "prift:stegosaurus", "prift:dodo", "prift:triceratops", "prift:parasaurolophus", "prift:megaloceros", "prift:gallimimus"}, "Identifiers of mobs that all carnivores will actively hunt");
