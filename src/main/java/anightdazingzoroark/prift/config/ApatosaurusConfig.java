...
public class ApatosaurusConfig extends RiftConfig {
    ...
    public static String[] apatosaurusFavoriteFood = {"minecraft:leaves:32767:0.025", "minecraft:leaves2:32767:0.025"};
    ...
    public void init() {
        ...
        apatosaurusFavoriteFood = config.getStringList("Apatosaurus Favorite Food", "General", new String[]{"minecraft:leaves:32767:0.025", "minecraft:leaves2:32767:0.025"}, "List of foods Apatosauruses will eat (when tamed) or pick up when on the ground. To add items add \"<insert item's identifier here>:<insert data id here>:<insert percentage of health that will be healed upon consumption here>\"");
