...
public class MegapiranhaConfig extends RiftConfig {
    ...
    public static int megapiranhaDensityLimit = 16;
    ...
    public static String[] megapiranhaTargets = {"minecraft:squid"};
    public static String[] megapiranhaTargetBlacklist = {};

    public MegapiranhaConfig(Configuration config) {
        super(config, new String[]{"all:25:4:6:WATER_CREATURE", "-tag:ocean"});
    ...
    public void init() {
        ...
        megapiranhaDensityLimit = config.getInt("Density Limit", "Spawning", 16, 1, 69620666, "Maximum amount of creatures of this type in a 64 x 64 x 64 area");
        ...
        megapiranhaTargets = config.getStringList("Megapiranha Targets", "General", new String[]{"minecraft:squid"}, "Identifiers of mobs that the Megapiranha will actively hunt, alongside the ones defined in the general config for all carnivores to target");
