...
public class MegapiranhaConfig extends RiftConfig {
    ...
    public static int megapiranhaDensityLimit = 48;
    ...
    public void init() {
        ...
        megapiranhaDensityLimit = config.getInt("Density Limit", "Spawning", 48, 1, 69620666, "Maximum amount of creatures of this type in a 64 x 64 x 64 area");
