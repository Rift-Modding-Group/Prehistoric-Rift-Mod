                        ...
                        .child(new Column().name("rightSide")
                                ...
                                .child(new Column().childPadding(2).coverChildren()
                                        ...
                                        .child(new ParentWidget<>().size(96, 3)
                                                .child(new Rectangle().color(0xFF000000).asWidget().size(96, 3))
                                                .child(new Rectangle().color(0xFF808080).asWidget().size(94, 1).center())
                                                .child(new Rectangle().color(0xFFFF0000).asWidget().height(1)
                                ...
                                .child(new Column().childPadding(2).coverChildren()
                                        ...
                                        .child(new ParentWidget<>().size(96, 3)
                                                .child(new Rectangle().color(0xFF000000).asWidget().size(96, 3))
                                                .child(new Rectangle().color(0xFF808080).asWidget().size(94, 1).center())
                                                .child(new Rectangle().color(0xFFFFFF00).asWidget().height(1)
                                ...
                                .child(new Column().childPadding(2).coverChildren()
                                        ...
                                        .child(new ParentWidget<>().size(96, 3)
                                                .child(new Rectangle().color(0xFF000000).asWidget().size(96, 3))
                                                .child(new Rectangle().color(0xFF808080).asWidget().size(94, 1).center())
                                                .child(new Rectangle().color(0xFF98D06B).asWidget().height(1)
