...
public class RiftControlButtonDisplay {
    ...
    private static int[] getUVsForControl(int keyBinding) {
        return switch (keyBinding) {
            case RiftControls.LEFT_MOUSE -> new int[]{16, 0};
            case RiftControls.RIGHT_MOUSE -> new int[]{32, 0};
            case RiftControls.MIDDLE_MOUSE -> new int[]{48, 0};
            case Keyboard.KEY_SPACE -> new int[]{0, 16};
            case Keyboard.KEY_UP -> new int[]{0, 32};
            case Keyboard.KEY_RIGHT -> new int[]{16, 32};
            case Keyboard.KEY_DOWN -> new int[]{32, 32};
            case Keyboard.KEY_LEFT -> new int[]{48, 32};
            default -> new int[]{0, 0};
        };
    }
