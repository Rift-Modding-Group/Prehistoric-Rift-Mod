...
public class RiftNewCreatureBoxInfoScreen extends RiftLibUI {
    ...
    public RiftNewCreatureBoxInfoScreen(int x, int y, int z) {
        super(x, y, z);
        this.selectedCreatureInfo = null;
    }

    public RiftNewCreatureBoxInfoScreen(BlockPos pos, SelectedCreatureInfo selectedCreatureInfo) {
