...
public class RiftBoxDeployedMemButton extends RiftLibClickableSection {
    private CreatureNBT creatureNBT;

    public RiftBoxDeployedMemButton(CreatureNBT creatureNBT, int guiWidth, int guiHeight, int xOffset, int yOffset, FontRenderer fontRenderer, Minecraft minecraft) {
    ...
    public void drawSection(int mouseX, int mouseY) {
        ...
        if (this.creatureNBT != null && !this.creatureNBT.nbtIsEmpty()) {
            ...
            //draw background
            //background changes based on whether or not creature is dead or not
            ...
            int xUVTexture = this.creatureNBT.getCreatureHealth()[0] <= 0 ? 64 : 0;
            int yUVTexture = 268;
