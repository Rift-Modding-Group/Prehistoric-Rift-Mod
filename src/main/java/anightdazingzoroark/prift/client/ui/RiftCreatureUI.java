...
public class RiftCreatureUI {
    public static ModularPanel show(RiftCreatureGuiData data, PanelSyncManager syncManager, UISettings settings) {
        ...
        //for stat table
        int statsNameColumnWidth = 70;
        int statsValueColumnWidth = 60;
        int statsIvColumnWidth = 25;
        ...
        return ModularPanel.defaultPanel("rift_creature", 176, inventoryRows * 18 + 122)
                ...
                .child(new PagedWidget<>()
                        ...
                        .addPage(Flow.column()
                                ...
                                .child(Flow.row().childPadding(8).coverChildren()
                                        .child(IKey.lang("gui.prift.tame_targeting").asWidget())
                                        .child(new CycleButtonWidget().syncHandler("tame_targeting").size(80, 20)
                                                .stateOverlay(
