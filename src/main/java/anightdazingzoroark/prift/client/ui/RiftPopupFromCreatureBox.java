            ...
            if (button.id == 0) {
                ...
                switch (swapType) {
                    case BOX_PARTY_SWAP:
                        ...
                        RiftMessages.WRAPPER.sendToServer(new RiftChangePartyOrBoxOrder(RiftChangePartyOrBoxOrder.SwapType.BOX_PARTY_SWAP, this.mc.player, this.valOne, this.valTwo));
