...
public class RiftJEISMPresserCategory implements IRecipeCategory<RiftJEISMPresserWrapper> {
    private final IDrawable background;
    private final IDrawableAnimated animatedArrow;
    private final IDrawable icon;

    public RiftJEISMPresserCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(new ItemStack(RiftMMItems.SEMI_MANUAL_PRESSER));
    ...
    public String getUid() {
        return RiftJEI.smPresserCat;
    }

    @Override
    public String getTitle() {
        return I18n.format("tile.semi_manual_presser.name");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout iRecipeLayout, RiftJEISMPresserWrapper riftJEISMPresserWrapper, IIngredients iIngredients) {
