...
import anightdazingzoroark.prift.compat.jei.wrapper.RiftJEIMillstoneWrapper;
...
public class RiftJEIMillstoneCategory implements IRecipeCategory<RiftJEIMillstoneWrapper> {
    private final IDrawable background;
    private final IDrawableAnimated animatedArrow;
    private final IDrawable icon;

    public RiftJEIMillstoneCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(new ItemStack(RiftMMBlocks.MILLSTONE));
    ...
    public String getUid() {
        return RiftJEI.millstoneCat;
    }

    @Override
    public String getTitle() {
        return I18n.format("tile.millstone.name");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout iRecipeLayout, RiftJEIMillstoneWrapper riftJEIMillstoneWrapper, IIngredients iIngredients) {
