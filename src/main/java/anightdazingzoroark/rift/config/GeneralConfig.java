...
public class GeneralConfig  extends RiftConfig {
    ...
    public void init() {
        ...
        quickEggHatch = config.getBoolean("All eggs hatch quickly", "General", false, "Turning this on makes all eggs hatch within 5 seconds. Mainly here for testing purposes, idk i could have made this a gamerule or smth");
    }
}