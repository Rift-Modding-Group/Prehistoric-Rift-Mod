...
public class RiftConfig {
    ...
    public static String[] mountOverrideWhitelistItems = {"item:minecraft:bow", "item:minecraft:shield"};
    public static String[] herbivoreRegenEnergyFoods = {"rift:fiber_bar:4"};
    public static String[] carnivoreRegenEnergyFoods = {"rift:raw_fibrous_meat:2", "rift:cooked_fibrous_meat:4"};

    public static String[] tyrannosaurusFavoriteFood = {"minecraft:beef", "minecraft:cooked_beef", "minecraft:porkchop", "minecraft:cooked_porkchop", "minecraft:chicken", "minecraft:cooked_chicken", "minecraft:mutton", "minecraft:cooked_mutton", "minecraft:rabbit", "minecraft:cooked_rabbit", "minecraft:rotten_flesh", "rift:raw_exotic_meat", "rift:cooked_exotic_meat", "rift:raw_fibrous_meat", "rift:cooked_fibrous_meat"};
